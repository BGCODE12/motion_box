package com.motionbox.motion_box.utils

import android.net.Uri
import com.google.gson.*
import com.motionbox.motion_box.models.EditOperation
import com.motionbox.motion_box.models.EditRecipe
...
object ProjectSerializer {
    ...
    fun serialize(recipe: EditRecipe): String = gson.toJson(recipe)
    fun deserialize(json: String): EditRecipe = gson.fromJson(json, EditRecipe::class.java)
}
